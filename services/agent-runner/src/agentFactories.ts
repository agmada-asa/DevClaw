    ...
    return [
        {
            ...
            content: [
                ...
                'CRITICAL: You MUST include one files[] entry for EVERY path listed in targetFiles/files for this sub-task.',
                'CRITICAL: If a target file does not exist yet, you must still include it in files[] with its full new contents.',
                'CRITICAL: Do not omit CSS, HTML, JS, or config files that are explicitly listed as target files.',
